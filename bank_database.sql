...
`default` varchar(30), /* `` is used for key words as name */
balance int,
housing varchar(30),
loan varchar(30),
contact varchar(30),
...
select min(age) from bank_details;
select max(age) from bank_details;
select avg(age) from bank_details;

select * from bank_details where marital="single" or education="unknown";
select * from bank_details where marital="single" or education="unknown" or balance<500;

select distinct job,marital,education,`default` from bank_details;
select distinct job from bank_details;
select distinct marital from bank_details;
select distinct education from bank_details;
select distinct `default` from bank_details;
select distinct duration from bank_details;
...
select * from bank_details where balance=(select min(balance),max(balance) from bank_details);
select min(balance),max(balance) from bank_details;

select * from bank_details where balance=(select min(balance) from bank_details) or
balance=(select max(balance) from bank_details);

select * from bank_details order by balance desc limit 5;

select job,marital,education,sum(duration) over (order by marital) as total from bank_details;

/*delimiters*/
delimiter $$
create procedure minimum1()
begin
select min(balance) from bank_details;
end$$
delimiter ;
...
delimiter $$
create procedure maximum3()
begin
select job,education,marital,max(balance) over(order by marital) as bal from bank_details;
end$$
delimiter ;
call maximum3();
